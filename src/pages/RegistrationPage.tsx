...
import { ChevronsRight, Crown, Zap } from "lucide-react";
      ...
      <main className="relative pt-32 pb-20 container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {passes.map((pass) => (
            <div
              key={pass.id}
              className={`relative group bg-zinc-900/40 border border-white/5 backdrop-blur-sm overflow-hidden flex flex-col transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(220,38,38,0.1)] ${
                pass.highlight ? "ring-1 ring-red-500/50" : ""
              }`}
            >
              {/* BACKGROUND LOGO */}
              <div className="absolute inset-0 z-0 opacity-10 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none flex items-center justify-center">
                <img
                  src={sparkLogo}
                  alt="Watermark"
                  className="w-[80%] h-auto object-contain opacity-50"
                />
              </div>
              ...
              <div className="absolute top-0 right-0 z-30">
                <div
                  className={`px-8 py-1.5 text-sm font-black font-orbitron tracking-widest rounded-full
                  ${
                    pass.highlight
              ...
              <div className="relative z-10 p-8 flex flex-col h-full pl-10">
                <div className="mb-6">
                  ...
                  <h3 className="text-5xl font-black font-orbitron italic tracking-tighter mb-2">
                    {pass.title}
                  </h3>
                ...
                <ul className="space-y-4 mb-10 flex-1">
                  {pass.includes.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <div className="mt-1 w-1.5 h-1.5 rounded-full bg-red-600" />
                ...
                <a
                  ...
                  className="w-full bg-red-600 hover:bg-red-700 text-white font-black font-orbitron text-lg uppercase py-4 tracking-widest transition-all duration-300 shadow-[0_0_20px_rgba(220,38,38,0.3)] hover:shadow-[0_0_40px_rgba(220,38,38,0.6)] flex items-center justify-center gap-2"
                >
                  REGISTER NOW
        ...
        <div className="mt-20 text-center max-w-2xl mx-auto">
          ...
          <a
            href="#"
            className="inline-flex items-center gap-2 text-white font-bold hover:text-red-500 transition-colors border-b border-dashed border-zinc-700 hover:border-red-500 pb-1"
          >
