...
const RulesRegulations = () => {
    ...
    const rules = [
        ...
        "In emergency situations, follow instructions given through the public address system.",
        ...
        "Student(s) identified with misconduct, drunken behavior, or physical altercation will be suspended and sent out. If necessary, they will be handed over to the police department.",
        "Maintain a positive and healthy environment throughout the event and cooperate with frisking at any point of time."
    ];
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    ...
                    >
                        ...
                        <p className="text-zinc-500 max-w-md">
                            Official directives for all participants. Non-compliance results in immediate action.
                        </p>
                    </motion.div>
                        ...
                        {rules.map((rule, i) => (
                            ...
                            >
                                <div className="mt-1 min-w-[24px] h-6 flex items-center justify-center rounded bg-white/5 border border-white/10 group-hover:border-red-500/50 group-hover:bg-red-500/10 transition-colors">
                                    <span className="text-[10px] font-bold text-zinc-500 group-hover:text-red-500">
                                        {i + 1}
                                    </span>
                                </div>

                                {/* ✅ FIXED MULTILINE TEXT */}
                                <p className="whitespace-pre-line text-zinc-400 text-sm leading-relaxed group-hover:text-zinc-300 transition-colors">
                                    {rule}
                                </p>
                            </motion.div>
                        ))}
